/*
  Problem 17: Find if two trees are structurally identical
  Time Complexity: O(n)
...
bool areIdentical (BTree *root1, BTree *root2) {
...
int main (void) {
  ...
  BTree *root2 = NULL;
  insertNode (&root2);
  cout<<"\nPreorder Traversal Tree 2:";
  preOrder (root2);
  cout<<"\nAre Identical:"<<areIdentical(root,root2);
  cout<<endl;
  return 0;
}
